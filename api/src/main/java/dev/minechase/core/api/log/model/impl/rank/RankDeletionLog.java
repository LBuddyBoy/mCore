...
@Getter
public class RankDeletionLog extends CoreLog implements SenderLog {

    private final UUID actorUUID;
    private final String initialRankName;
    private final UUID rankId;

    public RankDeletionLog(UUID actorUUID, Rank rank) {
        super("&6" + UUIDUtils.getName(actorUUID) + " &cdeleted &ethe '" + rank.getName() + "' rank!", CoreLogType.RANK_CREATED);
    ...
    public RankDeletionLog(Document document) {
        super(document);

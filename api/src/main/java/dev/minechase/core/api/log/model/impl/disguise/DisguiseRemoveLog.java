...
@Getter
public class DisguiseRemoveLog extends CoreLog implements TargetLog {

    private final UUID actorUUID;
    private final Rank disguiseRank;
    private final String disguiseName;

    public DisguiseRemoveLog(UUID actorUUID, String disguiseName, Rank rank) {
        super("&6" + UUIDUtils.getName(actorUUID) + " &cun-disguised&e as &6" + disguiseName + "&e with the &6" + rank.getName() + "&e rank!", CoreLogType.DISGUISE_REMOVED);
    ...
    public DisguiseRemoveLog(Document document) {
        super(document);
